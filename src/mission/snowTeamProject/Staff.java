...
public class Staff {
    ...
    public void readFileAndSetSneakerInfoMap() {
        try (BufferedReader fis = new BufferedReader(new FileReader("Learning-Java/Learning-Java/src/mission/snowTeamProject/input/nike-sneaker-characters.txt"))) {
    ...
    public void readFileAndSetSneakersStockMap() {
        try (BufferedReader fis = new BufferedReader(new FileReader("Learning-Java/Learning-Java/src/mission/snowTeamProject/input/nike-sneaker-stocks.txt"))) {
    ...
    public void printFileAfterSneakersStock() {
        try (PrintWriter printWriter = new PrintWriter(new FileWriter("Learning-Java/Learning-Java/src/mission/snowTeamProject/output/nike-sneaker-stocks-2.txt"))) {
    ...
    public void printFileAfterSale() {
        try (PrintWriter printWriter = new PrintWriter(new FileWriter("Learning-Java/Learning-Java/src/mission/snowTeamProject/output/staff-sales.txt"))) {
    ...
    public void printFileAfterTodayCount() {
        try (PrintWriter printWriter = new PrintWriter(new FileWriter("Learning-Java/Learning-Java/src/mission/snowTeamProject/output/today-sales.txt"), true)) {
