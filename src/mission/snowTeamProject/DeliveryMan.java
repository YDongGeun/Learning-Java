...
public class DeliveryMan {
    ...
    public void readFileAndSetSneakerDeliveryInfoMap() {
        try (BufferedReader fis = new BufferedReader(new FileReader("Learning-Java/Learning-Java/src/mission/snowTeamProject/input/nike-sneaker-delivery-infos.txt"))) {
    ...
    public void printFileAfterDelivery() {
        try (PrintWriter printWriter = new PrintWriter(new FileWriter("Learning-Java/Learning-Java/src/mission/snowTeamProject/output/delivery-manager-record.txt"))) {
